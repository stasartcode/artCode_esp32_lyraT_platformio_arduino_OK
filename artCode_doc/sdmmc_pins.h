...
#define SDMMC_SLOT0_IOMUX_PIN_NUM_CLK  6  // GPIO6
#define SDMMC_SLOT0_IOMUX_PIN_NUM_CMD  11 // GPIO11
...
#define SDMMC_SLOT1_IOMUX_PIN_NUM_CLK  14 // MicroSD Card / J5 - slot1
